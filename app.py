    ...
    def add_footer(self):
        ...
        with col2:
            ...
            <div style='display: flex; justify-content: center; align-items: center; margin-bottom: 10px;'>
                <a href='https://github.com/Sneha25-git/Smart-AI-Resume.git' target='_blank' style='text-decoration: none;'>
     ...
     "124852522.jpeg")
        ...
        st.markdown(f"""
            <div class="profile-section">
                <img src="{image_base64 if image_base64 else 'https://github.com/account'}"
                     alt="Sneha K"
                     class="profile-image"
                     onerror="this.onerror=null; this.src='https://github.com/account';">
                <h2 class="profile-name">Sneha25-git</h2>
                <p class="profile-title">AI/ML Enthusiast</p>
                <div class="social-links">
                    <a href="https://github.com/Sneha25-git" class="social-link" target="_blank">
                        <i class="fab fa-github"></i>
                    </a>
                    <a href="www.linkedin.com/in/snehakumari25" class="social-link" target="_blank">
                        <i class="fab fa-linkedin"></i>
                    </a>
                    <a href="sah.sneha06@gmail.com" class="social-link" target="_blank">
